...
Original file is located at
    https://colab.research.google.com/drive/1WoAwHtcrEv3vOw7UHLKYDnWPRlbG85xN
...
tokenizer.encode_plus('bonjour! WISD caption ')
...
files.upload()  # Téléchargez 'kaggle.json' ici
...
# Remplacer 'dataset' par l'URL ou l'ID du dataset Kaggle que vous voulez télécharger
# Par exemple, pour le dataset COCO 2017:
!kaggle datasets download -d awsaf49/coco-2017-dataset

# Extraire les fichiers du zip téléchargé
!unzip coco-2017-dataset.zip -d ./coco2017/

print(os.listdir('./coco2017/'))

# COCO 2017
base_path = Path('/content/coco2017/coco2017')
